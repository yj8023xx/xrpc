...
import com.smallc.xrpc.network.codec.XRpcMessageEncoder;
import com.smallc.xrpc.network.transport.InFlightRequests;
import com.smallc.xrpc.network.codec.XRpcResponseDecoder;
    ...
    private ChannelHandler newChannelHandlerPipeline() {
        return new ChannelInitializer<Channel>() {
            ...
            protected void initChannel(Channel channel) {
                channel.pipeline()
                        .addLast(new XRpcResponseDecoder())
                        .addLast(new XRpcMessageEncoder())
                        .addLast(new NettyResponseInvocation(inFlightRequests));
            }
        };
    }
