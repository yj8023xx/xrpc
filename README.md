...
xRPC 是一个轻量级、高吞吐、低延迟的 RPC 框架，能够为支持 RDMA 网络接口的应用提供超低延迟 RPC（5~6us）。本框架支持与 Spring 框架无缝整合，这意味着现有的 Spring 应用可以无缝地集成 xRPC，从而获得更高效、更快速的 RPC 通信，进一步提升整体应用性能和用户体验。
