...
public class TinyRpcResponseHeader extends TinyRpcHeader {
    ...
    public TinyRpcResponseHeader(int messageType, int serializeType, int requestId, Throwable throwable) {
        this(messageType, serializeType, requestId, TinyRpcCode.UNKNOWN_ERROR.getCode(), throwable.getMessage());
    }

    public TinyRpcResponseHeader(int messageType, int serializeMethod, int requestId) {
        this(messageType, serializeMethod, requestId, TinyRpcCode.SUCCESS.getCode(), null);
    }
