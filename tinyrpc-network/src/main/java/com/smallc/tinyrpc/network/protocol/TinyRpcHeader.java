...
public class TinyRpcHeader {
    ...
    public TinyRpcHeader(int messageType, int serializeMethod, int requestId) {
        this.messageType = messageType;
        this.serializeMethod = serializeMethod;
        this.requestId = requestId;
    }

    public TinyRpcHeader(int magicNumber, int version, int headerLength, int totalLength, int messageType, int serializeMethod, int requestId) {
    ...
    public TinyRpcHeader(TinyRpcHeader header) {
        this(header.getMagicNumber(), header.getVersion(), header.getHeaderLength(),
                header.getTotalLength(), header.getMessageType(), header.getSerializeMethod(), header.getRequestId());
    }
    ...
    public int getSerializeMethod() {
        return serializeMethod;
    }

    public void setSerializeMethod(int serializeMethod) {
        this.serializeMethod = serializeMethod;
    }
